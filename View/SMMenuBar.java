...
public class SMMenuBar extends MenuBar {

	// declared for access throughout class, as handlers are now attached via
	// methods - see towards end of class
	...
	// these methods allow handlers to be externally attached to this view and
